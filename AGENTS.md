...
- The one-shot CharaChorder startup contract and supported profile are documented in `docs/source/device-startup.rst`; `retype/services/device_snapshot.py` owns the read and atomic handoff to `BookView.setChords`.
