...
1. Menu
    A menu at the top of the window (or in the macOS system menu bar) that provides quick access to actions that are not context-sensitive, such as opening the :doc:`customisation-dialog`.
2. :doc:`console`
